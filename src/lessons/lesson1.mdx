...
<br></br>Note: To select the board, go to `Tools->Board->Arduino AVR Boards`, and find the Arduino UNO option.
<br></br>This is a hello world code for Arduino. The Setup code runs once.
<br></br>Try running this code on your IDE, and uploading to the Arduino! Typing it out might seem tedious, but it's the best way you will learn the language and structure.
<br></br>How do you run the code? Just click the right arrow button on the top left of the IDE! 
